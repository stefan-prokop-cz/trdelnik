use trdelnik::*;
use fehler::throws;
use program_client::account_data_matching_insecure_instruction;
use std::mem;
...
async fn test_insecure() {
    ...
    let mut fixture = Fixture {
        ...
        program_data: reader.program_data("account_data_matching_insecure").await?,
    ...
    account_data_matching_insecure_instruction::log_message(
        &fixture.client,
        fixture.token_account.pubkey(),
